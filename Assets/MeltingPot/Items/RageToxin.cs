...
namespace MeltingPot.Items
{
	class RageToxin: ItemBase<RageToxin>
	{
        ...
        public override string ItemFullDescription => $"Hitting enemies forces them to target you for <style=cStack>{baseDuration}s + ({durationGrowth}s per stack)</style>. Enraged enemies attack faster, but deal reduced damage and have a chance to fumble attacks";
        ...
        public static GameObject ItemModel => Assets.mainAssetBundle.LoadAsset<GameObject>("assets/meltingpot/mpassets/itemprefabs/rage_toxin/RageToxin.prefab");

        public GameObject Fumble_eff;// => MainAssets.LoadAsset<GameObject>("Fumble_MSG.prefab");

        public static GameObject ItemBodyModelPrefab;
        public static BuffDef RageBuff => ContentPackProvider.contentPack.buffDefs.Find("MeltingPot_Enraged");
        ...
        private void AggroSquelch(On.RoR2.CharacterBody.orig_OnSkillActivated orig, global::RoR2.CharacterBody self, global::RoR2.GenericSkill skill) {
            ...
            try {
                ...
                if (self.HasBuff(RageBuff) && aggroTracker) {
                    ...
                    if (Util.CheckRoll(1 - 1 / (1 + fumbleChance + fumbleGrowth * (aggroTracker.severity - 1)))) {
