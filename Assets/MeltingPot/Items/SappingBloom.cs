...
namespace MeltingPot.Items
{
    public class SappingBloom: ItemBase<SappingBloom>
    {
        ...
        public override string ItemPickupDesc => $"Chance to apply <style=cIsHealing>Weaken</style> on hit";
        public override string ItemFullDescription => $"<style=cIsHealing>{weakenChance*100}%</style> <style=cStack>(+{weakenChance*100}</style> per stack, stacking hyperbolically) of applying <style=cIsHealing>weaken</style> on hit";
        public override string ItemLore => "[A small note attached to the bundle]\n\n" +
        ...
        public static GameObject ItemModel => Assets.mainAssetBundle.LoadAsset<GameObject>("assets/meltingpot/mpassets/itemprefabs/sapping_bloom/sappingbloom.prefab");
        ...
        public override ItemDisplayRuleDict CreateItemDisplayRules() {
            ItemBodyModelPrefab = Assets.mainAssetBundle.LoadAsset<GameObject>("assets/meltingpot/mpassets/itemprefabs/sapping_bloom/displaysappingbloom.prefab");
