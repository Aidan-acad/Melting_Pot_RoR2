...
namespace MeltingPot.Items
{
	class EchoBang: ItemBase<EchoBang>
	{
        ...
        public override string ItemPickupDesc => $"Discharges a blast {fireDelay}s after an attack for <style=cStack>20% (+5% per stack)</style> of the damage in a <style=cStack>10m (+2.5m per stack)</style> radius";

        public override string ItemFullDescription => $"Discharges a blast {fireDelay}s after an attack for <style=cStack>20% (+5% per stack)</style> of the damage in a <style=cStack>10m (+2.5m per stack)</style> radius";
