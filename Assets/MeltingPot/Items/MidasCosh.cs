...
namespace MeltingPot.Items
{
    public class MidasCosh : ItemBase<MidasCosh>
    {
        ...
        private static float baseProcChance = 0.01f;
        ...
        public static GameObject ItemModel => Assets.mainAssetBundle.LoadAsset<GameObject>("assets/meltingpot/mpassets/itemprefabs/midas_cosh/midascosh.prefab");
        ...
        {
            ItemBodyModelPrefab = Assets.mainAssetBundle.LoadAsset<GameObject>("assets/meltingpot/mpassets/itemprefabs/midas_cosh/displaymidascosh.prefab");
