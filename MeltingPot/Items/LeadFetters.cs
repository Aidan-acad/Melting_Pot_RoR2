...
namespace MeltingPot.Items
{
    public class LeadFetters : ItemBase<LeadFetters>
    {
        ...
        public override string ItemLangTokenName => "LEAD_FETTERS";
        ...
        public override GameObject ItemModel => MainAssets.LoadAsset<GameObject>("LeadFetters.prefab");
        public override Sprite ItemIcon => MainAssets.LoadAsset<Sprite>("LeadFetters_Icon.PNG");

        public static GameObject ItemBodyModelPrefab;
        public static RoR2.BuffDef leadFetterBuff;
