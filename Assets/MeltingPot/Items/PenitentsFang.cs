...
{
    public class PenitentsFang : ItemBase<PenitentsFang>
    {

        public static float poisonChance = 0.1f;
        public override string ItemName => "Penitent's Fang";
        public override string ItemLangTokenName => "PENITFANG";
        public override string ItemPickupDesc => $"Chance to apply <style=cIsHealing>poison</style> on hit";
        public override string ItemFullDescription => $"<style=cIsHealing>{poisonChance*100}%</style> <style=cStack>(+{poisonChance*100}</style> per stack, stacking hyperbolically) of applying <style=cIsHealing>poison</style> on hit";
        ...
        public static GameObject ItemModel => Assets.mainAssetBundle.LoadAsset<GameObject>("assets/meltingpot/mpassets/itemprefabs/penit_fang/penitfang.prefab");
        ...
        public override void Init(ConfigFile config, bool enabled) {
            ...
            CreateItem("PenitFang_ItemDef", enabled);
            if (enabled) {
                CreateLang();
                Hooks();
            }
        ...
        public override ItemDisplayRuleDict CreateItemDisplayRules() {
            ItemBodyModelPrefab = Assets.mainAssetBundle.LoadAsset<GameObject>("assets/meltingpot/mpassets/itemprefabs/penit_fang/displaypenitfang.prefab");
        ...
        public override void Hooks() {
            On.RoR2.GlobalEventManager.OnHitEnemy += applyPoison;
        }
